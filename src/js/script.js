// Función para obtener la ruta base correcta (soporta GitHub Pages y desarrollo local)
function obtenerRutaBase() {
  const path = window.location.pathname;
  // Obtener la ruta hasta el último slash (incluyendo el slash)
  const lastSlashIndex = path.lastIndexOf('/');
  if (lastSlashIndex === -1) return './';
  return path.substring(0, lastSlashIndex + 1);
}

// Función para navegar a una página (compatible con GitHub Pages)
function navegarA(pagina) {
  // Si la página ya contiene una ruta completa (empieza con / o http), usarla directamente
  if (pagina.startsWith('/') || pagina.startsWith('http')) {
  ...
  // Si estamos en la raíz (index.html sin src/), ir a src/
  if (!pathActual.includes('/src/')) {
    window.location.href = rutaBase + 'src/' + pagina;
  } else {
    window.location.href = rutaBase + pagina;
  }
}
...
function compartirViaje(viaje) {
  ...
  const rutaBase = obtenerRutaBase();
  const url = window.location.origin + rutaBase + 'detalles_viaje.html';
...
const viajes = [
  ...
  {
    destino: 'España', continente: 'europa', duracion: 7, precio: 600, tipo: 'Turístico', mascotas: 'si', valoracion: 4, imagen: 'assets/images/viajes/Europa/España/madrid.jpg', titulo: 'Madrid, Barcelona y Sevilla', titulo_en: 'Madrid, Barcelona and Seville',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-gluten', 'sin-lactosa'],
    galeria: ['assets/images/viajes/Europa/España/madrid.jpg', 'assets/images/viajes/Europa/España/sagrada_familia.jpg', 'assets/images/viajes/Europa/España/real_alcazar.jpg', 'assets/images/viajes/Europa/España/parque_guell.jpg'],
    ...
    guia: { nombre: 'María González', edad: '32 años', edad_en: '32 years old', experiencia: '8 años de experiencia', experiencia_en: '8 years of experience', experiencias: 'Especialista en cultura española', experiencias_en: 'Spanish culture specialist', idiomas: 'Español, Inglés, Francés', idiomas_en: 'Spanish, English, French', contacto: '+34 612 345 678', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/maria_gonzalez.jpeg' },
    reseñas: [
      { nombre: 'Sergio Aladro', avatar: 'assets/images/avatares/Sergio.png', comentario: 'La mejor experiencia de mi vida, muy recomendado.', comentario_en: 'The best experience of my life, highly recommended.' },
      { nombre: 'Marcos Rodríguez', avatar: 'assets/images/avatares/Marcos.png', comentario: 'La comida en el viaje daba que desear pero el guía es uno de los mejores que he tenido', comentario_en: 'The food on the trip left something to be desired but the guide is one of the best I have had' }
    ]
  },
  {
    destino: 'España', continente: 'europa', duracion: 4, precio: 800, tipo: 'Aventura', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Europa/España/pirineos.jpg', titulo: 'Aventura en los Pirineos', titulo_en: 'Adventure in the Pyrenees',
    dietasDisponibles: ['vegano', 'sin-gluten', 'sin-frutos-secos'],
    galeria: ['assets/images/viajes/Europa/España/pirineos.jpg', 'assets/images/viajes/Europa/España/pirineos2.jpg', 'assets/images/viajes/Europa/España/pirineos3.jpeg', 'assets/images/viajes/Europa/España/rio_vero.jpeg'],
    ...
    guia: { nombre: 'Carlos Fernández', edad: '38 años', edad_en: '38 years old', experiencia: '15 años de experiencia', experiencia_en: '15 years of experience', experiencias: 'Guía de alta montaña certificado', experiencias_en: 'Certified high mountain guide', idiomas: 'Español, Inglés', idiomas_en: 'Spanish, English', contacto: '+34 678 234 567', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/carlos-fernandez.jpg' },
    reseñas: [
      { nombre: 'Jesus Galán', avatar: 'assets/images/avatares/Jesus.png', comentario: 'Increíble aventura, paisajes espectaculares y un grupo genial.', comentario_en: 'Incredible adventure, spectacular landscapes and a great group.' },
      { nombre: 'Alex Raboaca', avatar: 'assets/images/avatares/Alex.png', comentario: 'El guía fue muy profesional y atento, me sentí muy seguro en todo momento.', comentario_en: 'The guide was very professional and attentive, I felt safe at all times.' }
    ]
  },
  {
    destino: 'España', continente: 'europa', duracion: 10, precio: 500, tipo: 'Cultural', mascotas: 'no', valoracion: 4, imagen: 'assets/images/viajes/Europa/España/camino_santiago.jpeg', titulo: 'Camino de Santiago', titulo_en: 'Way of Saint James',
    dietasDisponibles: ['vegetariano', 'sin-lactosa', 'sin-huevo', 'sin-frutos-secos', 'halal'],
    galeria: ['assets/images/viajes/Europa/España/camino_santiago.jpeg', 'assets/images/viajes/Europa/España/catedral-santiago.jpeg', 'assets/images/viajes/Europa/España/palas_de_rei.jpg', 'assets/images/viajes/Europa/España/arzua.jpg'],
    ...
    guia: { nombre: 'Santiago Rodríguez', edad: '45 años', edad_en: '45 years old', experiencia: '12 años de experiencia', experiencia_en: '12 years of experience', experiencias: 'Más de 20 Caminos completados', experiencias_en: 'Over 20 Caminos completed', idiomas: 'Español, Inglés, Portugués', idiomas_en: 'Spanish, English, Portuguese', contacto: '+34 687 456 789', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/Santiago-rodriguez.jpg' },
    reseñas: [
      { nombre: 'Álvaro Ponz', avatar: 'assets/images/avatares/alvaro-ponz.png', comentario: 'Muy bien organizado, aunque el precio podría ser un poco más accesible.', comentario_en: 'Very well organized, although the price could be a bit more affordable.' }
    ]
  },

  {
    destino: 'Polonia', continente: 'europa', duracion: 3, precio: 200, tipo: 'Organizado', mascotas: 'si', valoracion: 3, imagen: 'assets/images/viajes/Europa/Polonia/varsovia.jpg', titulo: 'Varsovia: Historia y Renacimiento', titulo_en: 'Waersaw: History and Renaissance',
    dietasDisponibles: ['vegetariano', 'vegano', 'sin-gluten'],
    galeria: ['assets/images/viajes/Europa/Polonia/varsovia.jpg', 'assets/images/viajes/Europa/Polonia/castillo-real.jpg', 'assets/images/viajes/Europa/Polonia/museo-polin.jpg', 'assets/images/viajes/Europa/Polonia/parque-Łazienki.jpg'],
    ...
    guia: { nombre: 'Anna Kowalska', edad: '30 años', edad_en: '30 years old', experiencia: '10 años de experiencia', experiencia_en: '10 years of experience', experiencias: 'Experta en cultura e historia polaca', experiencias_en: 'Expert in Polish culture and history', idiomas: 'Español, Inglés, Polaco', idiomas_en: 'Spanish, English, Polish', contacto: '+48 600 123 576', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/anna-kowalska.jpg' },
    reseñas: [
      { nombre: 'Jon B.', avatar: 'assets/images/avatares/Jon.png', comentario: 'Me encantó la experiencia, muy bien organizada y con un guía excelente.', comentario_en: 'I loved the experience, very well organized and with an excellent guide.' }
    ]
  },
  ...
  {
    destino: 'Perú', continente: 'sudamerica', duracion: 4, precio: 400, tipo: 'Organizado', mascotas: 'si', valoracion: 3, imagen: 'assets/images/viajes/Sudamerica/Peru/peru_lima.jpg', titulo: 'Lima y la Costa', titulo_en: 'Lima and the Coast',
    dietasDisponibles: ['sin-pescado', 'vegano', 'vegetariano', 'sin-gluten', 'sin-lactosa'],
    galeria: ['assets/images/viajes/Sudamerica/Peru/peru_lima.jpg', 'assets/images/viajes/Sudamerica/Peru/Museo-Larco.jpg', 'assets/images/viajes/Sudamerica/Peru/pachacamac.jpg', 'assets/images/viajes/Sudamerica/Peru/playa-miraflores.jpeg'],
    ...
    guia: { nombre: 'Miguel Quispe', edad: '40 años', edad_en: '40 years old', experiencia: '10 años de experiencia', experiencia_en: '10 years of experience', experiencias: 'Experto en gastronomía peruana', experiencias_en: 'Peruvian gastronomy expert', idiomas: 'Español, Inglés, Quechua', idiomas_en: 'Spanish, English, Quechua', contacto: '+51 987 654 321', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 3, avatar: 'assets/images/avatares/miguel-quispe.jpg' },
    reseñas: [
      { nombre: 'Laura García', avatar: 'assets/images/avatares/laura-garcia.jpg', comentario: 'Experiencia única, el guía fue muy profesional y atento en todo momento.', comentario_en: 'Unique experience, the guide was very professional and attentive at all times.' }
    ]
  },
  {
    destino: 'Perú', continente: 'sudamerica', duracion: 6, precio: 600, tipo: 'Aventura', mascotas: 'no', valoracion: 4, imagen: 'assets/images/viajes/Sudamerica/Peru/machu_pichu.jpg', titulo: 'Machu Picchu Mágico', titulo_en: 'Magical Machu Picchu',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-gluten'],
    galeria: ['assets/images/viajes/Sudamerica/Peru/machu_pichu.jpg', 'assets/images/viajes/Sudamerica/Peru/cusco.jpg', 'assets/images/viajes/Sudamerica/Peru/Ollantaytambo.jpg', 'assets/images/viajes/Sudamerica/Peru/machu_pichu2.jpg'],
    ...
    guia: { nombre: 'Pedro Mamani', edad: '35 años', edad_en: '35 years old', experiencia: '11 años de experiencia', experiencia_en: '11 years of experience', experiencias: 'Guía oficial Machu Picchu', experiencias_en: 'Official Machu Picchu guide', idiomas: 'Español, Inglés, Quechua', idiomas_en: 'Spanish, English, Quechua', contacto: '+51 965 432 187', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/pedro-mamani.jpg' },
    reseñas: []
  },
  ...
  {
    destino: 'Japón', continente: 'asia', duracion: 5, precio: 500, tipo: 'Cultural', mascotas: 'si', valoracion: 5, imagen: 'assets/images/viajes/Asia/Japon/kioto.jpg', titulo: 'Kioto Tradicional', titulo_en: 'Traditional Kyoto',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-gluten', 'sin-lactosa', 'halal'],
    galeria: ['assets/images/viajes/Asia/Japon/kioto.jpg', 'assets/images/viajes/Asia/Japon/Kinkaku-ji.jpeg', 'assets/images/viajes/Asia/Japon/Nara.jpg', 'assets/images/viajes/Asia/Japon/Gion.jpg'],
    ...
    guia: { nombre: 'Yuki Tanaka', edad: '30 años', edad_en: '30 years old', experiencia: '7 años de experiencia', experiencia_en: '7 years of experience', experiencias: 'Experta en ceremonias tradicionales', experiencias_en: 'Expert in traditional ceremonies', idiomas: 'Japonés, Inglés, Español', idiomas_en: 'Japanese, English, Spanish', contacto: '+81 90 1234 5678', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/yuki-tanaka.jpg' },
    reseñas: []
  },
  {
    destino: 'Japón', continente: 'asia', duracion: 15, precio: 1000, tipo: 'Turístico', mascotas: 'no', valoracion: 4, imagen: 'assets/images/viajes/Asia/Japon/japon.jpg', titulo: 'Japón Completo', titulo_en: 'Complete Japan',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-pescado', 'sin-gluten', 'halal'],
    galeria: ['assets/images/viajes/Asia/Japon/japon.jpg', 'assets/images/viajes/Asia/Japon/shibuya.jpg', 'assets/images/viajes/Asia/Japon/hiroshima.jpg', 'assets/images/viajes/Asia/Japon/arashiyama.jpg', 'assets/images/viajes/Asia/Japon/miyajima.jpg', 'assets/images/viajes/Asia/Japon/monte-fuji.jpg'],
    ...
    guia: { nombre: 'Kenji Yamamoto', edad: '42 años', edad_en: '42 years old', experiencia: '16 años de experiencia', experiencia_en: '16 years of experience', experiencias: 'Especialista en tours completos', experiencias_en: 'Specialist in complete tours', idiomas: 'Japonés, Inglés, Mandarín', idiomas_en: 'Japanese, English, Mandarin', contacto: '+81 80 9876 5432', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/kenji-yamamoto.jpg' },
    reseñas: []
  },
  ...
  {
    destino: 'Argentina', continente: 'sudamerica', duracion: 8, precio: 1200, tipo: 'Aventura', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Sudamerica/Argentina/patagonia.jpg', titulo: 'Patagonia: Glaciares y Montañas', titulo_en: 'Patagonia: Glaciers and Mountains',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-gluten'],
    galeria: ['assets/images/viajes/Sudamerica/Argentina/patagonia.jpg', 'assets/images/viajes/Sudamerica/Argentina/ushuaia.jpg', 'assets/images/viajes/Sudamerica/Argentina/canal-beagle.jpg'],
    ...
    guia: { nombre: 'Laura Pérez', edad: '36 años', edad_en: '36 years old', experiencia: '10 años de experiencia', experiencia_en: '10 years of experience', experiencias: 'Guía en Patagonia', experiencias_en: 'Patagonia guide', idiomas: 'Español, Inglés', idiomas_en: 'Spanish, English', contacto: '+54 9 11 2345 6789', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/laura-perez.jpg' },
    reseñas: [{ nombre: 'María R.', avatar: 'assets/images/avatares/maria-r.jpg', comentario: 'Paisajes impresionantes y guía excepcional.', comentario_en: 'Impressive landscapes and exceptional guide.' }]
  },
  {
    destino: 'Maldivas', continente: 'asia', duracion: 4, precio: 1500, tipo: 'Organizado', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Asia/Maldivas/maldivas.jpg', titulo: 'Maldivas: Paraíso y Relax', titulo_en: 'Maldives: Paradise and Relaxation',
    dietasDisponibles: ['vegano', 'vegetariano'],
    galeria: ['assets/images/viajes/Asia/Maldivas/maldivas.jpg', 'assets/images/viajes/Asia/Maldivas/maldivas2.jpg', 'assets/images/viajes/Asia/Maldivas/snorkel_maldivas.jpg'],
    ...
    guia: { nombre: 'Ahmed Ali', edad: '30 años', edad_en: '30 years old', experiencia: '8 años de experiencia', experiencia_en: '8 years of experience', experiencias: 'Guía local en islas', experiencias_en: 'Local island guide', idiomas: 'Inglés', idiomas_en: 'English', contacto: '+960 777 1234', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/ahmed-ali.jpg' },
    reseñas: [{ nombre: 'Jaime C.', avatar: 'assets/images/avatares/Jaime.png', comentario: 'Un paraíso, servicio excelente.', comentario_en: 'A paradise, excellent service.' }]
  },
  {
    destino: 'Argentina', continente: 'sudamerica', duracion: 8, precio: 900, tipo: 'Turístico', mascotas: 'no', valoracion: 4, imagen: 'assets/images/viajes/Sudamerica/Argentina/cataratas_iguazu.jpg', titulo: 'Cataratas del Iguazú y Selva', titulo_en: 'Iguazu Falls and Jungle',
    dietasDisponibles: ['vegetariano', 'sin-gluten'],
    galeria: ['assets/images/viajes/Sudamerica/Argentina/cataratas_iguazu.jpg', 'assets/images/viajes/Sudamerica/Argentina/garganta_diablo.jpg', 'assets/images/viajes/Sudamerica/Argentina/itaipu.jpg'],
    ...
    guia: { nombre: 'Diego Morales', edad: '40 años', edad_en: '40 years old', experiencia: '12 años de experiencia', experiencia_en: '12 years of experience', experiencias: 'Guía de naturaleza', experiencias_en: 'Nature guide', idiomas: 'Español, Portugués', idiomas_en: 'Spanish, Portuguese', contacto: '+54 9 377 123 456', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/Roberto.jpg' },
    reseñas: []
  },
  ...
  {
    destino: 'Estados Unidos', continente: 'norteamerica', duracion: 7, precio: 1100, tipo: 'Turístico', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Norte America/new_yorl.jpeg', titulo: 'New York y la Costa Este', titulo_en: 'New York and the East Coast',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-gluten', 'halal'],
    galeria: ['assets/images/viajes/Norte America/new_yorl.jpeg', 'assets/images/viajes/Norte America/new_york_2.jpeg', 'assets/images/viajes/Norte America/new_york_3.jpg', 'assets/images/viajes/Norte America/costa_este.jpg'],
    ...
    guia: { nombre: 'Michael Johnson', edad: '35 años', edad_en: '35 years old', experiencia: '10 años de experiencia', experiencia_en: '10 years of experience', experiencias: 'Guía turístico Nueva York', experiencias_en: 'New York tour guide', idiomas: 'Inglés, Español', idiomas_en: 'English, Spanish', contacto: '+1 212 555 1234', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/michael-johnson.jpg' },
    reseñas: [{ nombre: 'Marco G.', avatar: 'assets/images/avatares/Marco.png', comentario: 'Nueva York es increíble, muy bien organizado.', comentario_en: 'New York is amazing, very well organized.' }]
  },
  {
    destino: 'Estados Unidos', continente: 'norteamerica', duracion: 9, precio: 1400, tipo: 'Aventura', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Norte America/cañon del colorado_2.jpg', titulo: 'Gran Cañón y Parques Nacionales', titulo_en: 'Grand Canyon and National Parks',
    dietasDisponibles: ['vegano', 'vegetariano'],
    galeria: ['assets/images/viajes/Norte America/cañon del colorado_2.jpg', 'assets/images/viajes/Norte America/cañon_del colorado_3.jpg'],
    ...
    guia: { nombre: 'David Williams', edad: '42 años', edad_en: '42 years old', experiencia: '15 años de experiencia', experiencia_en: '15 years of experience', experiencias: 'Experto en parques nacionales', experiencias_en: 'National parks expert', idiomas: 'Inglés', idiomas_en: 'English', contacto: '+1 702 555 5678', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/david-williams.jpg' },
    reseñas: [{ nombre: 'Pablo R.', avatar: 'assets/images/avatares/Pablo.png', comentario: 'Paisajes de otro planeta, una experiencia única.', comentario_en: 'Landscapes from another planet, a unique experience.' }]
  },

  // Africa

  {
    destino: 'Kenia', continente: 'africa', duracion: 8, precio: 2000, tipo: 'Aventura', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Africa/Kenia/safari kenia.jpg', titulo: 'Safari en Kenia: La Gran Migración', titulo_en: 'Kenya Safari: The Great Migration',
    dietasDisponibles: ['vegano', 'vegetariano', 'halal'],
    galeria: ['assets/images/viajes/Africa/Kenia/safari kenia.jpg', 'assets/images/viajes/Africa/Kenia/Safari kenia 2.jpeg', 'assets/images/viajes/Africa/Kenia/Safari Kenia 3.webp', 'assets/images/viajes/Africa/Kenia/safari kenia 4.jpeg', 'assets/images/viajes/Africa/Kenia/Safari kenia 5.jpg'],
    ...
    guia: { nombre: 'Joseph Kimani', edad: '38 años', edad_en: '38 years old', experiencia: '12 años', experiencia_en: '12 years of experience', experiencias: 'Guía de safari certificado', experiencias_en: 'Certified safari guide', idiomas: 'Inglés, Suajili', idiomas_en: 'English, Swahili', contacto: '+254 700 123 456', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/joseph-kimani.jpg' },
    reseñas: [{ nombre: 'David H.', avatar: 'assets/images/avatares/David.png', comentario: 'Ver los Big Five fue un sueño cumplido.', comentario_en: 'Seeing the Big Five was a dream come true.' }]
  },

  {
    destino: 'Egipto', continente: 'africa', duracion: 3, precio: 150, tipo: 'Aventura', mascotas: 'no', valoracion: 3, imagen: 'assets/images/viajes/Africa/Egipto/el-cairo.jpg', titulo: 'Aventura por Egipto', titulo_en: 'Adventure through Egypt',
    dietasDisponibles: ['vegetariano', 'sin-pescado', 'sin-huevo','halal'],
    galeria: ['assets/images/viajes/Africa/Egipto/el-cairo.jpg', 'assets/images/viajes/Africa/Egipto/bazar-egipto.jpg', 'assets/images/viajes/Africa/Egipto/piramide-giza.jpg', 'assets/images/viajes/Africa/Egipto/esfinge.jpg', 'assets/images/viajes/Africa/Egipto/Nilo.jpg'],
    ...
    guia: { nombre: 'Omar Hussein', edad: '39 años', edad_en: '39 years old', experiencia: '10 años', experiencia_en: '10 years of experience', experiencias: 'Egiptólogo y conocedor de gastronomía local', experiencias_en: 'Egyptologist and local gastronomy expert', idiomas: 'Árabe, Español, Inglés', idiomas_en: 'Arabic, Spanish, English', contacto: '+20 100 034 2589', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 3, avatar: 'assets/images/avatares/omar-hussein.jpg' },
    reseñas: [{ nombre: 'Juan Manuel C.', avatar: 'assets/images/avatares/Juancho.png', comentario: 'Una experiencia cultural enriquecedora.', comentario_en: 'An enriching cultural experience.' }]
  },

  {
    destino: 'Marruecos', continente: 'africa', duracion: 6, precio: 800, tipo: 'Cultural', mascotas: 'no', valoracion: 4, imagen: 'assets/images/viajes/Africa/Marruecos/marruecos 1.jpg', titulo: 'Marruecos: De Marrakech al Desierto', titulo_en: 'Morocco: From Marrakech to the Desert',
    dietasDisponibles: ['vegano', 'vegetariano', 'halal'],
    galeria: ['assets/images/viajes/Africa/Marruecos/marruecos 1.jpg', 'assets/images/viajes/Africa/Marruecos/Marruecos 2.jpg', 'assets/images/viajes/Africa/Marruecos/Marruecos 3.webp', 'assets/images/viajes/Africa/Marruecos/Marruecos 4.jpg', 'assets/images/viajes/Africa/Marruecos/Marruecos 5.jpg', 'assets/images/viajes/Africa/Marruecos/Marruecos 6.webp'],
    ...
    guia: { nombre: 'Hassan Benali', edad: '45 años', edad_en: '45 years old', experiencia: '20 años', experiencia_en: '20 years of experience', experiencias: 'Experto en cultura bereber', experiencias_en: 'Berber culture expert', idiomas: 'Árabe, Francés, Español, Inglés', idiomas_en: 'Arabic, French, Spanish, English', contacto: '+212 600 123 456', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 4, avatar: 'assets/images/avatares/hassan-benali.jpg' },
    reseñas: []
  },
  ...
  {
    destino: 'Australia', continente: 'oceania', duracion: 7, precio: 2500, tipo: 'Turístico', mascotas: 'si', valoracion: 5, imagen: 'assets/images/viajes/Oceania/Sidney 2.jpg', titulo: 'Australia: Sydney y la Gran Barrera', titulo_en: 'Australia: Sydney and the Great Barrier Reef',
    dietasDisponibles: ['vegano', 'vegetariano', 'sin-gluten'],
    galeria: ['assets/images/viajes/Oceania/Sidney 2.jpg', 'assets/images/viajes/Oceania/Sidney 3.jpg', 'assets/images/viajes/Oceania/Gran barrera_2.webp'],
    ...
    guia: { nombre: 'Emma Thompson', edad: '32 años', edad_en: '32 years old', experiencia: '8 años', experiencia_en: '8 years of experience', experiencias: 'Guía turística certificada', experiencias_en: 'Certified tour guide', idiomas: 'Inglés', idiomas_en: 'English', contacto: '+61 400 123 456', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/emma-thompson.jpg' },
    reseñas: [{ nombre: 'Dani S.', avatar: 'assets/images/avatares/Dani_S.png', comentario: 'Australia superó todas mis expectativas.', comentario_en: 'Australia exceeded all my expectations.' }]
  },
  {
    destino: 'Nueva Zelanda', continente: 'oceania', duracion: 7, precio: 2200, tipo: 'Aventura', mascotas: 'no', valoracion: 5, imagen: 'assets/images/viajes/Oceania/Nueva_Zelanda_1.jpeg', titulo: 'Nueva Zelanda: Tierra Media', titulo_en: 'New Zealand: Middle Earth',
    dietasDisponibles: ['vegano', 'vegetariano'],
    galeria: ['assets/images/viajes/Oceania/Nueva_Zelanda_1.jpeg', 'assets/images/viajes/Oceania/Nueva_zelanda_3.webp', 'assets/images/viajes/Oceania/Nueva_Zelanda_4.jpg', 'assets/images/viajes/Oceania/Nueva_Zelanzda_4.jpeg', 'assets/images/viajes/Oceania/NUeva_Zelanda_5.webp'],
    ...
    guia: { nombre: 'James Wilson', edad: '40 años', edad_en: '40 years old', experiencia: '15 años', experiencia_en: '15 years of experience', experiencias: 'Experto en Tierra Media', experiencias_en: 'Middle Earth expert', idiomas: 'Inglés', idiomas_en: 'English', contacto: '+64 21 123 456', redesSociales: ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'], valoracion: 5, avatar: 'assets/images/avatares/james-wilson.jpg' },
    reseñas: []
  }
];
...
// Botones de iniciar sesión y registrarse en el header (funciona en todas las páginas)
...
if (window.location.pathname.includes("detalles_viaje.html") || window.location.pathname.endsWith("detalles_viaje")) {
  ...
  function generarInfoGuia(guia = {}) {
    ...
    const redesSociales = guia.redesSociales || ['<img src="assets/images/redes_sociales/instagram.png" alt="Instagram"/>', '<img src="assets/images/redes_sociales/facebook.png" alt="Facebook"/>', '<img src="assets/images/redes_sociales/linkedin.png" alt="LinkedIn"/>'];
  ...
  if (botonReservar) {
    botonReservar.addEventListener('click', () => {
      ...
      navegarA('formulario_compra.html');
    });
  }
}
...
if (window.location.pathname.includes("formulario_compra.html")) {
  ...
  if (formularioPaso1) {
    ...
    formularioPaso1.addEventListener('submit', function (e) {
      ...
      navegarA('formulario_compra2.html');
    });
  }
}
...
if (window.location.pathname.includes("formulario_compra2.html")) {
  ...
  const catalogoDietas = {
    'vegano': { nombre: 'Vegano', icono: 'assets/images/dietas/vegano.jpg' },
    'vegetariano': { nombre: 'Vegetariano', icono: 'assets/images/dietas/vegetariano.jpg' },
    'sin-gluten': { nombre: 'Sin gluten', icono: 'assets/images/dietas/sin-gluten.jpg' },
    'sin-lactosa': { nombre: 'Sin lactosa', icono: 'assets/images/dietas/sin-lactosa.jpg' },
    'sin-pescado': { nombre: 'Sin pescado', icono: 'assets/images/dietas/sin-pescado.jpg' },
    'sin-frutos-secos': { nombre: 'Sin frutos secos', icono: 'assets/images/dietas/sin-frutos-secos.png' },
    'sin-huevo': { nombre: 'Sin huevo', icono: 'assets/images/dietas/sin-huevo.jpg' },
    'halal': { nombre: 'Halal', icono: 'assets/images/dietas/halal.jpg' },
  };
  ...
  if (botonSiguiente) {
    botonSiguiente.addEventListener('click', () => {
      ...
      // Redirigir al paso 3
      alert('Datos guardados correctamente. Ahora serás redirigido al siguiente paso.');
      navegarA('formulario_compra3.html');
    });
  }
}
...
if (window.location.pathname.includes("formulario_compra3.html")) {
  ...
  if (botonConfirmarCompra) {
    botonConfirmarCompra.addEventListener('click', () => {
      ...
      navegarA('compra_realizada.html');
    });
  }
}
  ...
  const blogs = [
    {
      ...
      estado: "en-curso",
      imagen: "assets/images/blogs/top-sorprendentes.jpg",
      contenido: `
    ...
    },
    {
      ...
      estado: "finalizado",
      imagen: "assets/images/blogs/sin-mapa.jpg",
      contenido: `
    ...
    },
    {
      ...
      estado: "finalizado",
      imagen: "assets/images/blogs/trekking.jpg",
      contenido: `
    ...
    },
    {
      ...
      categoria: "itinerarios",
      estado: "finalizado",
      imagen: "assets/images/blogs/Europa.jpg",
      contenido: `
    ...
    },
    {
      ...
      categoria: "equipamiento",
      estado: "en-curso",
      imagen: "assets/images/blogs/empacar-ligero.jpeg",
      contenido: `
    ...
    },
    {
      ...
      categoria: "experiencias",
      estado: "finalizado",
      imagen: "assets/images/blogs/asia-gastro.jpg",
      contenido: `
